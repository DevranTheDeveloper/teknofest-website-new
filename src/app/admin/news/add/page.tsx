...
export default function AddNewsPage() {
    ...
    async function createNews(formData: FormData) {
        ...
        // Date is optional, defaults to now() in DB if not provided, but let's allow user to pick
    ...
    return (
        <div className="max-w-4xl mx-auto">
            <div className="mb-6 flex items-center gap-4">
                ...
                <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Add News Article</h1>
            </div>

            <form action={createNews} className="space-y-6 bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                <div className="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" required
                            ...
                            placeholder="e.g. Teknofest 2024 Winners Announced"
                        />
                    </div>

                    {/* Date */}
                    <div>
                        <label htmlFor="date" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Publish Date (Optional)</label>
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 mb-2">Displayed on the news card.</p>
